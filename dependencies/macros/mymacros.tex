...
% ** Eirini's corner **
%
%    \Note : Highlights with red colour     - indicates standard note by author
%
%    \RP   : Highlights with magenta colour - reserved for notes by Riccardo
%    \LC   : Highlights with blue colour    - reserved for notes by Luca
%    \EC   : Highlights with cyan colour    - reserved for notes by Eirini
%    \TP   : Highlights with green colour   - reserved for notes by Tasos
%
%    \markasold : Highlights with yellow colour  - indicates `old' or `outdated' material
%
%
% ** Luca's corner **
%
%    \Future  : Defines the symbol to be used (in maths mode) to denote `future' observations
%    \Other   : Defines the symbol to be used (in maths mode) to denote `other' observations
%    \TR      : The transpose operator
%    \RV      : A Bold x
%    \ParamsQ : A bold beta parameter
%    \Q       : A q_beta symbol
%
%    \beginsupplement: 
%
%
% ** Tasos's big messy pile **
%
...
%    \nevermind        :  Types Nevermind in a consistent style
...
% Eirini's corner:
  \newcommand{\Note}[1]{{\color{red}\bfseries[NOTE: #1]}}
  %\renewcommand{\Note}[1]{} % Uncomment this to disable comments
  \newcommand{\markasold}[1]{\hl{#1}}
  \newcommand{\RP}[1]{{\color{magenta}\bfseries[RP: #1]}}
  \newcommand{\LC}[1]{{\color{blue}\bfseries[LC: #1]}}
  \newcommand{\EC}[1]{{\color{cyan}\bfseries[EC: #1]}}
  \newcommand{\TP}[1]{{\color{green}\bfseries[TP: #1]}}


% Luca's corner:
  \newcommand{\Future}{^+} % future observations
  \newcommand{\Other}{_{\bar s}} % other subjects
  \newcommand{\TR}{^{\!\mathsf T}}
  \newcommand{\RV}{\mathbf x}
  \newcommand{\ParamsQ}{\boldsymbol{\beta}}
  \newcommand{\Q}{q}
  \newcommand{\QBeta}{\Q_{\mbox{\tiny$\ParamsQ$}}}
